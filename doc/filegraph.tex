...
function printctxgenericlist ()
 t= luaotfload.filelist.selectctxgenericentries (luaotfload.filelist.data)
 local rowcnt = 0
 local sep = "&"
 for i,v in ipairs (t) do
  rowcnt = rowcnt + 1
...
function printlibrarylist ()
 t = luaotfload.filelist.selectlibraryentries (luaotfload.filelist.data)
 local rowcnt = 0
 local sep = "&"
 for i,v in ipairs (t) do
  rowcnt = rowcnt + 1
...
function printscriptlist ()
 t = luaotfload.filelist.selectscriptentries (luaotfload.filelist.data)
 for i,v in ipairs ( t ) do
  if v.kind == 8 then 
    tex.sprint( v.name .."\\\\")
  end  
