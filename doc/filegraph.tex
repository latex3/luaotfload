...
function printctxfontlist ()
 for i,v in ipairs (luaotfload.filelist.ctxfontlist ( luaotfload.filelist.data )) do
  tex.sprint("\\mbox{"..v.."} ")
 end 
end
...
function printctxlibslist ()
 local rowcnt = 0
 local sep = "&"
 for i,v in ipairs (luaotfload.filelist.ctxlibslist ( luaotfload.filelist.data )) do
  rowcnt = rowcnt + 1
  if rowcnt % 4 == 0 then sep = "\\\\" else sep = "&" end
  tex.sprint("\\mbox{"..v.."}".. sep)
 end
end
...
function printctxgenericlist ()
 local rowcnt = 0
 local sep = "&"
 for i,v in ipairs (luaotfload.filelist.ctxgenericlist ( luaotfload.filelist.data )) do
  rowcnt = rowcnt + 1
...
function printlibrarylist ()
 local rowcnt = 0
 local sep = "&"
 for i,v in ipairs (luaotfload.filelist.librarylist ( luaotfload.filelist.data )) do
  rowcnt = rowcnt + 1
  if rowcnt % 2 == 0 then sep = "\\\\" else sep = "&" end
  tex.sprint("\\mbox{"..v.."}".. sep)
 end
...
function printscriptlist ()
 for i,v in ipairs (luaotfload.filelist.data ) do
  if v.kind == 8 then 
    tex.sprint(v.name .."\\\\")
  end  
 end
