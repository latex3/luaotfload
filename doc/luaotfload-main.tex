...
\begindescriptions
  ...
  The core of documentation is nearly unchanged. I only added this introduction. I recreated with the help of @marmot the graphic. I updated the file lists. I imported as appendix pdf versions of the two man files which are part of the \identifier{Luaotfload} documentation.
  \endaltitem
