...
\beginfrontmatter
  ...
  \setdocumentdate   {2018/09/21 v2.9}
...
On the one side there is not much new in this version: The native components of \identifier{Luaotfload} are nearly unchanged. Only a few bugs have been corrected.
...
\begindescriptions
  ...
  The documentation is nearly unchanged. I only added this introduction. I recreated with the help of @marmot the graphic. I updated the file list. I imported as appendix pdf versions of the two man files which are part of the \identifier{Luaotfload} documentation.
  \endaltitem
...
\begindoublecolumns
  \begindefinitions
      ...
      \beginaltitem {l-unicode.lua}      \endaltitem
...
\begindefinitions
  ...
  %      \beginaltitem{luatex-fonts-syn.lua}  \endaltitem %ignored
        \beginaltitem{luatex-fonts-ext.lua}  \endaltitem
        \beginaltitem{luatex-fonts-def.lua}  \endaltitem
        \beginaltitem{luatex-fonts-lig.lua}  \endaltitem
        \beginaltitem{luatex-fonts-gbn.lua}  \endaltitem
      \enddefinitions
    \enddoublecolumns
  \endnormalitem
  ...
  \beginnormalitem
    ...
    \begindoublecolumns
      \begindefinitions
        ...
        \beginaltitem{font-vfc.lua} \endaltitem
        \beginaltitem{font-oti.lua} \endaltitem
        \beginaltitem{font-otr.lua} \endaltitem
        \beginaltitem{font-ott.lua} \endaltitem
        ...
        \beginaltitem{font-otc.lua} \endaltitem
        \beginaltitem{font-onr.lua} \endaltitem
        ...
        \beginaltitem{font-imp-tex.lua} \endaltitem
        \beginaltitem{font-imp-ligatures.lua} \endaltitem
        \beginaltitem{font-imp-italics.lua} \endaltitem
        \beginaltitem{font-imp-effects.lua} \endaltitem
      \enddefinitions
    \enddoublecolumns
  \endnormalitem
\enddefinitions
