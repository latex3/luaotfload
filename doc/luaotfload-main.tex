...
\beginfrontmatter
  ...
  \setdocumentdate   {2018/10/18 v2.92}
...
\begin{itemize}
  ...
  \item \identifier{Luaotfload} doesn't work when luatex is used with the option \inlinecode{--safer}, it now aborts cleanly when the option is detected -- you still can errors from fontspec later.
  \item  {file}The (broken) syntax \inlinecode{file:} for legacy font works again. 
