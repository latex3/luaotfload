...
\beginfrontmatter
  ...
  \setdocumentdate   {2019-01-28 v2.9602}
...
\begin{itemize}
\item \textbf{Incompatible change!} 
In version 2.95 letterspacing was broken due to a change in the fontloader. This has been repaired. At the same time a number of oddities and bugs of the letterspacing has been corrected. This can change existing documents. 
...
\begindescriptions
  ...
  \beginaltitem {kernfactor \& letterspace}
         ...
         pair of glyphs.
         %
         \marginpar{New v2.96} Ligatures are split into their component glyphs unless
