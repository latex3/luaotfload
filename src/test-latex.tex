...
\setmainfont{Amiri}[\mode, Script=Arabic]
...
\begingroup\pardir TRT\textdir TRT
\fontspec{Amiri}[\mode, Script=Arabic, Scale=1.6]
\setstretch{2.4}
\arabictext
\par\endgroup\newpage

\begingroup\pardir TRT\textdir TRT
\fontspec{Aref Ruqaa}[\mode, Script=Arabic, Scale=1.2]
\setstretch{2.4}
\arabictext
\par\endgroup\newpage

\begingroup\pardir TRT\textdir TRT
\fontspec{Noto Nastaliq Urdu}[\mode, Script=Arabic]
\setstretch{2.5}
\arabictext
\par\endgroup\newpage

\begingroup\pardir TRT\textdir TRT
\fontspec{Amiri}[\mode, Script=Arabic, Scale=2]
قلبي {\addfontfeature{Color=FF0000} تلون كله} بلون الحب.
\par\endgroup\newpage

\begingroup\pardir TRT\textdir TRT
\fontspec{Amiri Quran Colored}[\mode, Script=Arabic, Scale=2]
\setstretch{3.8}
\parindent=0pt
...
\begingroup
\fontspec{BungeeColor1.ttf}[\mode, Script=Latin, RawFeature={colr=true}, Scale=5]
ABCDEFG\par
\fontspec{BungeeColor1.ttf}[\mode, Script=Latin, RawFeature={colr=2}, Scale=5]
ABCDEFG\par

\fontspec{Noto Color Emoji}[\mode, Scale=2]
💙💚💛💜💝🖤🧡😀😇🧔
\endgroup\newpage
...
\def\l#1#2{%
  \begingroup%
  \fontspec{amiri-regular.ttf}[\mode, Script=Arabic, Language=#1]
  #2%
  \endgroup%
}
...
\begingroup
\parindent=0pt
\fontspec{NotoSerifCJK-Regular.ttc}[\mode, Script=Latin]
...
\newfontfamily\testr{lmroman10-regular.otf}[\mode, Script=Latin, Ligatures=Discretionary]
\begingroup
\parindent=0pt
\testr
\noindent
...
\newfontfamily\testb{lmroman10-bold.otf}[\mode, Script=Latin]
\newfontfamily\testi{lmromanslant10-regular.otf}[\mode, Script=Latin]
\newfontfamily\testR{lmroman12-regular.otf}[\mode, Script=Latin, Scale=1.2]
\testr
\hrule
\vskip 1in
