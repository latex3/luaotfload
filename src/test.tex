...
\tracingonline=1
\iftrue
  \directlua{dofile("harf.lua")}
  \def\script#1{}
\else
  \input luaotfload.sty
  \def\script#1{script=#1;}
\fi
\font\testr="[lmroman10-regular.otf]:\script{latn}+dlig" at 10pt
...
\font\testB="[amiri-bold.ttf]:\script{arab}" at 10pt
\font\testI="[amiri-slanted.ttf]:\script{arab}" at 10pt
\font\testF="[NotoSerifCJK-Regular.ttc]:\script{latn}" at 10pt
\font\testa="[amiri-regular.ttf]:\script{arab}" at 20pt
...
\def\l#1#2{%
  \begingroup%
  \font\testl="[amiri-regular.ttf]:\script{arab}language=#1" at 10pt
  \testl #2%
  \endgroup%
}
