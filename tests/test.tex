...
\font\letterspace="[amiri-regular.ttf]:mode=harf;letterspace=50" at 30pt\letterspace
letter spaced

\font\kernfactor="[amiri-regular.ttf]:mode=harf;kernfactor=.5" at 30pt\kernfactor
letter spaced
...
\font\squeeze="[amiri-regular.ttf]:mode=harf;squeeze=.5" at 30pt\squeeze
...
\begingroup
\font\hkfont"[Free-HK-Kai_4700-v1.02.subset.ttf]"
\hkfont
骨窗次
\endgroup\vfill\eject

\begingroup
\font\test="[URWGothicL-Book.subset.otf]:mode=harf"
\test
åäöüñÅÄÖÜÑ
\endgroup\vfill\eject
...
\begingroup
\font\tlig="[lmroman10-regular.otf]:+tlig;mode=harf" at 20pt
\tlig
``!`'' `?`' f--f f---f f-f ,,f" <<f>>
\endgroup\vfill\eject

\begingroup
\font\fandol="[FandolSong-Regular.otf]:mode=harf" at 20pt
\fandol
